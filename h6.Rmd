...
##B. Find counts by aggregating from regression like the last homework; then group by rater, summarise for totals by rater, then mutate
  ## based on counts as denominator with rater group as numerator
##C. Would do the mixed effect with indivdual level variables included
...
##B
  ##1. 0.044117048
  ##2. alpha-j = 3.5 + 2.25 * (.04411) => 3.599
  ##3. 3.501325
  ##4. 3.501325
  ##5. alpha-j = 3.5 + .008Age + .38Emp + .14Spouse + 2.21*Alabama
